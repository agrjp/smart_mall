...
class GoodsDetailsScreen extends StatefulWidget {
  const GoodsDetailsScreen({Key? key, required this.goods}) : super(key: key);
  final Goods goods;
  @override
                  ...
                  SizedBox(
                    ...
                    child: Stack(
                      children: [
                        Swiper(
                          autoplay: true,
                          itemCount: widget.goods.photos.length,
                          duration: 500,
                          autoplayDelay: 2000,
                          itemBuilder: (content, index) {
                            return Image.network(
                              "http://${widget.goods.photos[index]}",
                              fit: BoxFit.fill,
                              width: double.infinity,
                        ...
                        Align(
                            ...
                            child: Container(
                              ...
                              height: 19,
                              child: Text(
                                "${_swiperIndex + 1}/${widget.goods.photos.length}",
