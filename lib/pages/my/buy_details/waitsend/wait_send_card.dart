...
class WaitSendCard extends StatefulWidget {
  const WaitSendCard({Key? key,required this.goods}) : super(key: key);
  final Goods goods;
  @override
  State<WaitSendCard> createState() => _WaitSendCardState();
}

class _WaitSendCardState extends State<WaitSendCard> {
  var image_url =
