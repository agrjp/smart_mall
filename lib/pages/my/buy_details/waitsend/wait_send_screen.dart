...
class WaitSendScreen extends StatefulWidget {
  const WaitSendScreen({Key? key}) : super(key: key);

  @override
  State<WaitSendScreen> createState() => _WaitSendScreenState();
}

class _WaitSendScreenState extends State<WaitSendScreen> {
  ...
  void initState() {
    ...
    super.initState();
    //异步！！
    EasyHttp.instance.selectGoodsByIDAndStatus("待发货",userId).then((value) {
      setState(() {
        _waitPayList = value;
      });
    });
        ...
        child: Container(
          ...
          child: ListView.builder(
            ...
            // physics: NeverScrollableScrollPhysics(),
              ...
              itemBuilder: (context,index){return WaitSendCard(goods: _waitPayList[index]);}),
        )
    );
  }
}
