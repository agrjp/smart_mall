...
import 'package:smart_mall/pages/my/buy_details/received/recevied_card.dart';
...
class _ReceivedScreenState extends State<ReceivedScreen> {
  ...
  void initState() {
    ...
    super.initState();
    //异步！！
    EasyHttp.instance.selectGoodsByIDAndStatus("已签收",userId).then((value) {
      setState(() {
        _waitPayList = value;
      });
    });
    ...
    return SmartRefresher(
        ...
        child: Container(
          ...
          child: ListView.builder(
              ...
              itemBuilder: (context,index){return ReceivedCard(goods: _waitPayList[index]);}),
        )
    );
  }
}
